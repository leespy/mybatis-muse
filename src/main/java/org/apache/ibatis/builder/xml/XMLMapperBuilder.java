...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    private ResultMap resultMapElement(XNode resultMapNode, List<ResultMapping> additionalResultMappings)
        ...
        // type加载优先级顺序：resultType > javaType > ofType
        ...
        ResultMapResolver resultMapResolver =
                new ResultMapResolver(builderAssistant, id, typeClass, extend, discriminator, resultMappings,
                        autoMapping);
        try {
    ...
    private ResultMapping buildResultMappingFromContext(XNode context, Class<?> resultType, List<ResultFlag> flags)
        ...
        /**
         * 获得局部sql的加载策略，局部策略（<association fetchType="lazy"> or <collection fetchType="lazy">）
         * 覆盖全局策略（<settings><setting name="lazyLoadingEnabled" value="true"/></settings>）
         */
